...
const createChat = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const chat = yield chat_model_1.ChatModel.create({ name, description, users, messages });
...
const getChatById = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    try {
        const chat = yield chat_model_1.ChatModel.findById(id);
        if (chat) {
            return res.status(200).json({ chat });
        }
...
const updateChat = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const { name, description, users, messages } = req.body;
    try {
        const chat = yield chat_model_1.ChatModel.findByIdAndUpdate(id, { name, description, users, messages });
        if (chat) {
...
const deleteChat = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    try {
        const deleted = yield chat_model_1.ChatModel.findByIdAndDelete(id);
        if (deleted) {
